...
BEGIN
    ...
    CREATE TEMPORARY TABLE IF NOT EXISTS temp_avg_wghtd_scores (
    ...
    INSERT INTO temp_avg_wghtd_scores (user_id, avg_weighted_score)
    ...
    UPDATE users AS U
    JOIN temp_avg_wghtd_scores AS T ON U.id = T.user_id
    ...
    DROP TEMPORARY TABLE IF EXISTS temp_avg_wghtd_scores;
END
$$
